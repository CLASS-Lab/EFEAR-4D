...
typedef boost::shared_ptr<EFEAR_4D::Registration> regPtr;
...
public:
  ...
  virtual bool Register(std::vector<MapNormalPtr>& scans, std::vector<Eigen::Isometry3d>& Tsrc, std::vector<Matrix6d>& reg_cov, bool soft_constraints = false)=0;
...
void Isometry3dToEigVectorXYeZ(const Eigen::Affine3d& T, Eigen::Vector3d& par);

void Isometry3dToVectorXYeZ(const Eigen::Affine3d& T, std::vector<double>& par) ;
